	...
	function mostrar(respuesta){
		if(respuesta!='Token no valido'){
			...
			document.getElementById('alertClock').innerHTML='<p align="center"><strong>Reloj del sistema:&nbsp;' + valores[10] + '&nbsp;' + valores[11] + '/' + valores[12] + '/20' + valores[13] + '&nbsp;&nbsp;&nbsp;&nbsp;' + valores[14] + ':' + valores[15] + ':' + valores[16] + '</strong></a>';
		}
		else{
			clearInterval(x);
